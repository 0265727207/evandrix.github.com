...
if installer == True:
	...
	if os.path.isfile("/etc/apt/sources.list"):
		...
		subprocess.Popen("apt-get --force-yes -y install subversion build-essential python-pexpect python-beautifulsoup python-pefile python-crypto python-openssl", shell=True).wait()
