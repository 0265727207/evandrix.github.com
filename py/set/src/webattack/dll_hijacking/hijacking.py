...
from src.core.core import show_banner,get_version
...
choice=raw_input("\n   Enter your choice for the vulnerable application (return for default): ")
...
subprocess.Popen("mkdir src/program_junk/dll 1> /dev/null 2> /dev/null", shell=True).wait()
filename1=raw_input("Enter the filename for the attack for example openthis (enter for default): ")
...
# flag a choice
choice=raw_input("Enter your selecting (press return for default): ")
