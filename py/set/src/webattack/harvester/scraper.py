...
fileopen=file("src/webattack/web_clone/site/template/%s" % (site),"r").readlines()
...
subprocess.Popen("mv src/webattack/web_clone/site/template/index.html.new src/webattack/web_clone/site/template/%s 1> /dev/null 2> /dev/null" % (site), shell=True).wait()
