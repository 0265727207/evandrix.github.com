...
fileopen=file("src/program_junk/site.template", "r")
site_template = file("src/program_junk/site.template", "r").readlines()
fileopen1=file("src/core/reports/index.html", "r")
...
subprocess.Popen("cp -rf src/core/reports/files reports/ 1> /dev/null 2> /dev/null", shell=True).wait()
