...
spearphish_text = ("""   Welcome to the SET E-Mail attack method. This module allows you
...
webattack_menu = ['The Java Applet Attack Method',
...
webattack_text = ("""   The Social-Engineer Toolkit "Web Attack" vector is
   a unique way of utilizing multiple web-based attacks in order to
...
webattack_vectors_menu = ['Web Templates','Site Cloner','Custom Import','Return to main menu']

webattack_vectors_text =("""   The first method will allow SET to import a list of pre-defined
...
sms_attack_menu = ['Perform a SMS Spoofing Attack','Create a Social-Engineering Template\n','Return to Main Menu']
...
infectious_menu = ['File-Format Exploits','Standard Metasploit Executable']


infectious_text = bcolors.GREEN + """
...
payload_menu_1 = [' Windows Shell Reverse_TCP               Spawn a command shell on victim and send back to attacker',
                  ...
                  'SET Custom Written Interactive Shell    This is the new custom interactive reverse shell designed for SET',
                  'RATTE HTTP Tunneling Payload            This is a security bypass payload that will tunnel all comms over HTTP',
                  'Import your own executable              Specify a path for your own executable']

payload_menu_1_text = """   What payload do you want to generate:
...
payload_menu_2 = [' Windows Shell Reverse_TCP               Spawn a command shell on victim and send back to attacker',
                  ' Windows Reverse_TCP Meterpreter         Spawn a meterpreter shell on victim and send back to attacker',
                  ' Windows Reverse_TCP VNC DLL             Spawn a VNC server on victim and send back to attacker',
                  ' Windows Bind Shell                      Execute payload and create an accepting port on remote system.',
                  ' Windows Bind Shell X64                  Windows x64 Command Shell, Bind TCP Inline',
...
payload_menu_2_text = """   What payload do you want to generate:

    Name:                                      Description:
"""

payload_menu_3 = ['Windows Reverse TCP Shell              Spawn a command shell on victim and send back to attacker',
...
# called from create_payload.py
# associated dictionary = ms_attacks
create_payloads_menu = [' SET Custom Written DLL Hijacking Attack Vector (RAR, ZIP)',
...
browser_exploits_menu = [' MS11-050 IE mshtml!CObjectElement Use After Free',
                         ...
                         ' Internet Explorer CSS Import Use After Free',
...
encoder_menu = [' avoid_utf8_tolower JOEY (Normal)',
