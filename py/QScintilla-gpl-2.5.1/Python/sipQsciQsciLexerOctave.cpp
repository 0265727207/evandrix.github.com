...
{
    return (sip_Qsci_qt_metacast && sip_Qsci_qt_metacast(sipPySelf,sipType_QsciLexerOctave,_clname)) ? this : QsciLexerOctave::qt_metacast(_clname);
}
...
const char * sipQsciLexerOctave::language() const
{
    ...
    return sipVH_Qsci_13(sipGILState,sipMeth,-47,sipPySelf);
}
...
const char * sipQsciLexerOctave::lexer() const
{
    ...
    return sipVH_Qsci_13(sipGILState,sipMeth,-48,sipPySelf);
}
...
const char * sipQsciLexerOctave::keywords(int a0) const
{
    ...
    return ((sipVH_QtGui_146)(sipModuleAPI_Qsci_QtGui->em_virthandlers[146]))(sipGILState,sipMeth,a0,-49,sipPySelf);
}
...
extern "C" {static void *init_QsciLexerOctave(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_QsciLexerOctave(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **sipOwner, PyObject **sipParseErr)
{
...
static sipEncodedTypeDef supers_QsciLexerOctave[] = {{25, 255, 1}};
