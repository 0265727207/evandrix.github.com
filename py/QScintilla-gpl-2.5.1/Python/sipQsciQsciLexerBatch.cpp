...
{
    return (sip_Qsci_qt_metacast && sip_Qsci_qt_metacast(sipPySelf,sipType_QsciLexerBatch,_clname)) ? this : QsciLexerBatch::qt_metacast(_clname);
}
...
const char * sipQsciLexerBatch::language() const
{
    ...
    return sipVH_Qsci_13(sipGILState,sipMeth,-98,sipPySelf);
}
...
const char * sipQsciLexerBatch::lexer() const
{
    ...
    return sipVH_Qsci_13(sipGILState,sipMeth,-99,sipPySelf);
}
...
const char * sipQsciLexerBatch::keywords(int a0) const
{
    ...
    return ((sipVH_QtGui_146)(sipModuleAPI_Qsci_QtGui->em_virthandlers[146]))(sipGILState,sipMeth,a0,-100,sipPySelf);
}
...
extern "C" {static void *init_QsciLexerBatch(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_QsciLexerBatch(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **sipOwner, PyObject **sipParseErr)
{
...
static sipEncodedTypeDef supers_QsciLexerBatch[] = {{7, 255, 1}};
...
static sipEnumMemberDef enummembers_QsciLexerBatch[] = {
    {sipName_Comment, QsciLexerBatch::Comment, -1},
    {sipName_Default, QsciLexerBatch::Default, -1},
    {sipName_ExternalCommand, QsciLexerBatch::ExternalCommand, -1},
    {sipName_HideCommandChar, QsciLexerBatch::HideCommandChar, -1},
    {sipName_Keyword, QsciLexerBatch::Keyword, -1},
    {sipName_Label, QsciLexerBatch::Label, -1},
    {sipName_Operator, QsciLexerBatch::Operator, -1},
    {sipName_Variable, QsciLexerBatch::Variable, -1},
};
